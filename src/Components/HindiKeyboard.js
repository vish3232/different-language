          ...
          <div
            ...
            <div className="keyboard-main-container" >
              <div className="subcontainer1" >
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? "-" : "ॊ"
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? "-" : "ॊ"
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "१" : "1"}` : `${capsLockEnable ? "ऍ" : "1"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "१" : "1"}` : `${capsLockEnable ? "ऍ" : "1"}`}` ? "key-container key-container-active" : "key-container"}  >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "२" : "2"}` : `${capsLockEnable ? "ॅ" : "2"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "२" : "2"}` : `${capsLockEnable ? "ॅ" : "2"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "३" : "3"}` : `${capsLockEnable ? "्र" : "3"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "३" : "3"}` : `${capsLockEnable ? "्र" : "3"}`
                  }` ? "key-container key-container-active" : "key-container"}  >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "४" : "4"}` : `${capsLockEnable ? "र्" : "4"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "४" : "4"}` : `${capsLockEnable ? "र्" : "4"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                    {
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "५" : "5"}` : `${capsLockEnable ? "ज्ञ" : "5"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "५" : "5"}` : `${capsLockEnable ? "ज्ञ" : "5"}`}` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                    {
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "६" : "6"}` : `${capsLockEnable ? "त्र" : "6"}`
                    }`}`)); setcapsLockEnable(false)
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "७" : "7"}` : `${capsLockEnable ? "क्ष" : "7"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "७" : "7"}` : `${capsLockEnable ? "क्ष" : "7"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "८" : "8"}` : `${capsLockEnable ? "श्र" : "8"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "८" : "8"}` : `${capsLockEnable ? "श्र" : "8"}`}` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                    {
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "९" : "9"}` : `${capsLockEnable ? "(" : "9"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "९" : "9"}` : `${capsLockEnable ? "(" : "9"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "०" : "0"}` : `${capsLockEnable ? ")" : "0"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "०" : "0"}` : `${capsLockEnable ? ")" : "0"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "-"}` : `${capsLockEnable ? "ः" : "-"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "-"}` : `${capsLockEnable ? "ः" : "-"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ॄ" : "ृ"}` : `${capsLockEnable ? "ऋ" : "ृ"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ॄ" : "ृ"}` : `${capsLockEnable ? "ऋ" : "ृ"}`}` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
              ...
              <div className="subcontainer2" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "औ" : "ौ"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "औ" : "ौ"}`}` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऐ" : "ै"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऐ" : "ै"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "आ" : "ा"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "आ" : "ा"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ॣ" : "ृ"}` : `${capsLockEnable ? "ई" : "ी"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ॣ" : "ृ"}` : `${capsLockEnable ? "ई" : "ी"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऊ" : "ू"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऊ" : "ू"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "भ" : "ब"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "भ" : "ब"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ङ" : "ह"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ङ" : "ह"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ग़" : "ृ"}` : `${capsLockEnable ? "घ" : "ग"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ग़" : "ृ"}` : `${capsLockEnable ? "घ" : "ग"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ध" : "द"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ध" : "द"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ज़" : "ृ"}` : `${capsLockEnable ? "झ" : "ज"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ज़" : "ृ"}` : `${capsLockEnable ? "झ" : "ज"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ड़" : "ृ"}` : `${capsLockEnable ? "ढ" : "ड"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ड़" : "ृ"}` : `${capsLockEnable ? "ढ" : "ड"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ञ" : "़"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ञ" : "़"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऑ" : "ॉ"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऑ" : "ॉ"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
              ...
              <div className="subcontainer3" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ओ" : "ो"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ओ" : "ो"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                    {
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ए" : "े"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ए" : "े"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "अ" : "्"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "अ" : "्"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "ॢ" : "ृ"}` : `${capsLockEnable ? "इ" : "ि"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "ॢ" : "ृ"}` : `${capsLockEnable ? "इ" : "ि"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "उ" : "ु"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "उ" : "ु"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "फ" : "प"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "फ" : "प"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऱ" : "र"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऱ" : "र"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "क़" : "ृ"}` : `${capsLockEnable ? "ख" : "क"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "क़" : "ृ"}` : `${capsLockEnable ? "ख" : "क"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "थ" : "त"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "थ" : "त"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "" : "ृ"}` : `${capsLockEnable ? "छ" : "च"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "f" : "ृ"}` : `${capsLockEnable ? "छ" : "च"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ठ" : "ट"}`
                    }`}`))
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ठ" : "ट"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
              ...
              <div className="subcontainer4" >
                ...
                <div onClick={() => dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऎ" : "ॆ"}`
                  }`}`))} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऎ" : "ॆ"}`
                    }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ँ" : "ं"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ँ" : "ं"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ण" : "म"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ण" : "म"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऩ" : "न"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऩ" : "न"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऴ" : "व"}`
                    }`}`));; setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ऴ" : "व"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ळ" : "ल"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "ळ" : "ल"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "श" : "स"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "श" : "स"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "॰" : "ृ"}` : `${capsLockEnable ? "श" : ","}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "॰" : "ृ"}` : `${capsLockEnable ? "श" : ","}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => { dispatch(concatCharacter(`${word + `${capsLockEnable ? "।" : "."}`}`)); setcapsLockEnable(false) }} className={selectedKey === `${controlEnable ? `${controlEnable ? "॥" : "ृ"}` : `${capsLockEnable ? "।" : "."}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
                ...
                <div onClick={() => {
                  dispatch(concatCharacter(`${word + `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "य़" : "य"}`
                    }`}`)); setcapsLockEnable(false)
                }} className={selectedKey === `${controlEnable ? `${controlEnable ? "-" : "ृ"}` : `${capsLockEnable ? "य़" : "य"}`
                  }` ? "key-container key-container-active" : "key-container"} >
                  <div className="key-content" >
