...
import {keyPress,SpanishKeyboardPress} from '../Functions/functions'
...
<div className="key-container">
        <div onClick={() => setText( keyPress(shift?"ª":"º"))}>{shift?"ª":"º"} </div>
...
<div className="key-container">
        ...
        <div onClick={() => setText(keyPress(shift?"^":"`"))}>{shift?"^":"`"}</div>
<div onClick={() => setText(keyPress(shift?"*":"+"))}>{shift?"*":"+"} </div>
<div onClick={() => setText(keyPress(shift?"Ç":"ç"))}>{shift?"Ç":"ç"} </div>
...
<div onClick={() => setText(keyPress(shift?"Ñ":"ñ"))}>{shift?"Ñ":"ñ"} </div>
<div onClick={() => setText(keyPress(shift?"¨":"´"))}>{shift?"¨":"´"} </div>
...
<div className="button-container1">
    <div className="search-container">
      <input onKeyDown={(e) => setText(SpanishKeyboardPress(e))}
